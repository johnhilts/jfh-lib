...
(cffi:define-foreign-library libwebauthn-es256
  (:linux "libwebauthn-es256.so") ;; TODO do we need both of these?
  (t "libwebauthn-es256.so"))

(cffi:use-foreign-library libwebauthn-es256)

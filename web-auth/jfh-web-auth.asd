...
(defsystem #:jfh-web-auth
  ...
  :version "0.0.1"
  :serial t
  :depends-on (#:cffi #:cl+ssl #:hunchentoot #:jfh-configuration #:jfh-security #:jfh-auth #:jfh-user #:jfh-web-server #:cl-base32 #:cl-one-time-passwords #:ironclad #:cbor #:cl-json)

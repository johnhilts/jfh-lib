...
(defclass application-user-login (application-user-identifier jfh-store:user-index-data)
  ((%user-login
    :reader user-login
    :initarg :user-login))
...
(defclass application-user-api-key (application-user-identifier jfh-store:user-index-data)
  ((%user-api-key
    :reader user-api-key
    :initarg :user-api-key))
...
(defclass application-user-fingerprint (application-user-identifier jfh-store:user-index-data)
  ((%user-fingerprint
    :reader user-fingerprint
    :initarg :user-fingerprint
    ;; :type simple-vector
